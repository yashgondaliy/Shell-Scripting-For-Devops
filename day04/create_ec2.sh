...
install_awscli() {
	echo "Installing AWS CLI v2 pn linux..."
...
main() {
	...
	if ! check_awscli ; then
    	...
    	KEY_NAME="create_Shell_ec2_key"
    	SUBNET_ID="subnet-0051adfcd892e6a4e"
    	SECURITY_GROUP_IDS="sg-06f2ed45d9038d89a"  # Add your security group IDs separated by space
